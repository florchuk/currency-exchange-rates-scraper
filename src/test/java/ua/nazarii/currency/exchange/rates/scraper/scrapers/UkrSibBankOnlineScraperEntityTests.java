...
public class UkrSibBankOnlineScraperEntityTests {
    private static String response;

    @Spy
    private final Scraper scraper = new UkrSibBankOnlineScraper();
    ...
    public static void initAll() throws IOException, NullPointerException {
        try (
                InputStream inputStream =
                        UkrSibBankOnlineScraperEntityTests.class.getClassLoader()
                                .getResourceAsStream("scrapers/response-ukrsibbank-online.html")
        ) {
            UkrSibBankOnlineScraperEntityTests.response = new String(Objects.requireNonNull(inputStream).readAllBytes());
        }
    }
    ...
    public void getRateDtosTest() throws Exception {
        ...
        Mockito.doReturn(UkrSibBankOnlineScraperEntityTests.response).when(this.scraper).getResponse();
